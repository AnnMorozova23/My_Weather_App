package com.example.myweatherapp.modul.entities
...
private val CITY = "Москва"
private val LAT = 55.755826
private val LON = 37.617299900000035

fun getDefaultCity() = City(CITY, LAT, LON)
